...
internal sealed class CheckChooseFromForeignCommandHandler : IRequestHandler<CheckChooseFromForeignCommand, GuessResult>
{
    ...
    public CheckChooseFromForeignCommandHandler(
    ...
    public async Task<GuessResult> Handle(CheckChooseFromForeignCommand command, CancellationToken cancellationToken)
    {
        ...
        if (activeStage.ExerciseType is not ExerciseType.ChooseFromForeign)
        {
