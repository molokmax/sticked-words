...
internal sealed class GetChooseFromNativeQueryHandler : IRequestHandler<GetChooseFromNativeQuery, ChooseExercise>
{
    private readonly IFlashCardRepository _repository;
    private readonly UserService _userService;
    private readonly AccessPolicy _accessPolicy;

    public GetChooseFromNativeQueryHandler(
    ...
    public async Task<ChooseExercise> Handle(GetChooseFromNativeQuery request, CancellationToken cancellationToken)
    {
        ...
        string[] options = [flashCard.Translation, .. wrongFlashCards.Data.Select(x => x.Translation)];
